...
const Footer = () => {
  return (
    <footer aria-label="Site Footer" className="bg-red-600/90 border-t border-gray-100">
      <div className="mx-auto max-w-screen-xl px-4 pb-4 pt-8 sm:px-6 lg:px-8 lg:pt-24">
