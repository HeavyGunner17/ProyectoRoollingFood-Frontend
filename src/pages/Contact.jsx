...
const Contact = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      emailjs
        .send("service_es3ljxf", "template_2uphri3", formData, "YOUR_USER_ID")
        .then(() => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            >
              <div className="flex flex-col">
                ...
                />
                {errors.firstName && (
                  <span className="text-red-500 mt-2">{errors.firstName}</span>
                )}
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-green-600 hover:bg-red-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-red-500 transition ease-in-out duration-300"
              >
                Submit
              </button>
            </form>
